...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    System.out.println("Please enter the second whole nuber you would like to add. ");
    ...
    double subdub = dub1 + dub2 + dub3;

    System.out.println("The sum of " + num1 + "+" + num2 + "+" + num3 + "= " + sum);
    System.out.println("The sum of " + dub1 + "+" + dub2 + "+" + dub3 + "= " + subdub);
    }
}
